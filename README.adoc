...
Looking at Monkey #0 and #1, and their Operations (`*19` and `+6`) make me start
a simple handrolled parser.
Monkey #3 (`new = old * old`) i switched from this basic parser to the Go
